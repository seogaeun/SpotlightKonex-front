                ...
                <div className="login-field">
                    <div className="login-input">
                        ...
                        <div className="rule">
                            ...
                            <p className="rule-result">최대 {formatNumberWithCommas(deductionAmount)}을 공제 받으실 수 있습니다.</p>
                            <div className="result-desc">지방소득세를 포함한 소득 세부산정 기준에 따라 달라질 수 있습니다.
                                조합출자금액이 아닌 투자금액 기준입니다.</div>
                            <a href="https://home.kban.or.kr/" className="angel-btn">
                                <span>
                                    엔젤투자 시작하기
                                    <FiLogIn />
                                </span>
